...
SECRET_KEY = 'django-insecure-^trl_q&e*&d&+$5!lrfmkpbi*k^x3=fi1^qi=kvq3&64vko#%d'
...
MIDDLEWARE = [
    ...
    'common.middleware.SysRequestResponseMiddleware'
]
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 100000,
    'EXCEPTION_HANDLER': 'common.exceptions.sys_exception_handler'
